...
import soma from '../../alga/espacos-soma.typ?raw';
...
<Dot
  source={
    'graph {\n  espaco [label="plano R2"];\n  reta [label="reta y = 2x (subespaço)"];\n  uniao [label="união dos eixos (não é subespaço)"];\n  espaco -- reta;\n  espaco -- uniao;\n}'
  }
  alt="O plano R2 contém a reta y igual a 2x, que é subespaço, e a união dos eixos, que não é subespaço."
/>
...
Dois vetores independentes e a sua soma desenham sempre um paralelogramo, como o de $u_1$, $u_2$ e $u_1 + u_2$:

<Typst
  source={soma}
  format="svg"
  alt="Paralelogramo com lados u1 e u2 e diagonal u1 mais u2."
/>

O teste de independência muda com a dimensão, mas a ideia é a mesma:

<Tabs id="independencia-r2-r3" labels={['Em R2', 'Em R3']}>
  <div slot="panel-0">

<p>
  Dois vetores são independentes quando nenhum é múltiplo do outro. Em contas, o
  determinante da matriz que os tem como colunas tem de ser não nulo: para (1,
  0) e (1, 1) dá 1.
</p>
...
<p>
  Dois vetores nunca chegam para uma base de R3: geram no máximo um plano. Para
  três vetores, o teste é o determinante 3x3, ou, o que é o mesmo, verificar se
  o produto misto é não nulo.
</p>
...
Estes dois vídeos mostram a mesma matéria com desenhos animados: vetores, combinações lineares, span e bases.
...
- [Intuição visual de span e base](https://www.3blue1brown.com/lessons/span/), com animações de combinações lineares no plano.
- [Interactive Linear Algebra](https://textbooks.math.gatech.edu/ila/index.html), manual aberto com capítulos interativos por tema.
