...
[^clairaut]:
    A demonstração está, por exemplo, no capítulo de derivadas parciais do manual aberto _Calculus Volume 3_ (OpenStax): [openstax.org/details/books/calculus-volume-3](https://openstax.org/details/books/calculus-volume-3).
    :::
