...
import esfera from '../../am2/esfera-fluxo.typ?raw';
import calota from '../../am2/calota-tampa.typ?raw';
...
<Typst
  source={esfera}
  format="svg"
  alt="Esfera com setas da normal exterior e setas verticais do campo z vezes k a atravessá-la de baixo para cima."
/>
...
O fluxo total para fora iguala a soma das fontes interiores.

<Tabs id="vias-fluxo" labels={['Via direta', 'Pela divergência']}>
  <div slot="panel-0">

  Parametrizar a esfera, calcular $\vec{F} \cdot \vec{N}$ e integrar em $u$ e $v$, como feito na secção anterior: $\Phi = 4\pi a^3/3$.

  </div>
  <div slot="panel-1">

  Para $\vec{F} = z\,\hat{k}$, $\nabla \cdot \vec{F} = 1$, e o fluxo através da esfera é simplesmente o volume da bola: $4\pi a^3/3$. É o mesmo valor do cálculo direto, obtido aqui numa linha.

  </div>
</Tabs>

Sempre que a divergência é constante (ou simples) e a superfície é fechada, este teorema evita parametrizar.
...
<Typst
  source={calota}
  format="svg"
  alt="Calota S com a tampa T a fechar a base: o fluxo por S é o fluxo pela superfície fechada menos o fluxo pela tampa."
/>
:::
...
<YouTube id="rB83DpBJQsE" title="Divergence and curl (3Blue1Brown)" />

## Para saber mais

- Notas de Paul sobre o [teorema de Stokes](https://tutorial.math.lamar.edu/Classes/CalcIII/StokesTheorem.aspx), com exemplos e orientação de superfícies.
- O curso [Multivariable Calculus do MIT (18.02)](https://ocw.mit.edu/courses/18-02-multivariable-calculus-fall-2007/), com aulas e problemas sobre estes teoremas.
