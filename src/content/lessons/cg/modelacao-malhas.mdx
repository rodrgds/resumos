...
import normal from './normal.typ?raw';
import malha from './malha.dot?raw';
...
<Dot
  source={malha}
  alt="Grafo da estrutura da malha: a malha divide-se em vértices com posições 3D, arestas como pares de vértices e faces como trios de vértices."
/>
...
O desenho mostra esse triângulo visto de cima: os vértices $A$, $B$ e $C$ por ordem contrária aos ponteiros do relógio, e a normal a sair da página para $+z$, marcada com o ponto da convenção de desenho técnico.

<Typst
  source={normal}
  format="svg"
  alt="Triângulo com vértices A na origem, B no eixo horizontal e C no eixo vertical. No centro, um ponto marca a normal a sair da página na direção mais z."
/>
