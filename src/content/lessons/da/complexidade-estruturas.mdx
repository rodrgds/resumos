...
$O(1)$ não quer dizer instantâneo, quer dizer independente de $n$. E o pior caso manda: um algoritmo que é rápido quase sempre mas explode numa entrada adversa é um algoritmo $O(\text{explos\~ao})$. Nos mini-testes, identifica sempre se te pedem pior caso, caso médio ou amortizado[^amortizado].
:::
