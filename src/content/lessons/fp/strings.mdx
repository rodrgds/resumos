...
import indices from '../../fp/indices-fatias.typ?raw';
...
O esquema marca cada posição de `'programar'` com o seu índice e a fatia `[0:4]` por cima.

<Typst
  source={indices}
  format="svg"
  alt="Esquema dos índices de programar de 0 a 8, com a fatia de 0 a 4 assinalada por cima."
/>
...
Experimenta a versão curta com outra palavra e prevê o resultado antes de correres.

<CodePlayground
  language="python"
  title="Inverter com fatia"
  code={"s = 'programar'\nprint(s[::-1])"}
/>
