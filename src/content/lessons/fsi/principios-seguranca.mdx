...
import matriz from '../../fsi/risco.typ?raw';
...
<Typst
  source={matriz}
  format="svg"
  alt="Matriz de risco três por três. Linhas de impacto e colunas de probabilidade de um a três, com os produtos em cada célula. O cenário A ocupa a célula dois vezes três igual a seis e o cenário B a célula três vezes três igual a nove."
/>
