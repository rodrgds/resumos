...
<Tabs
  id="arquiteturas-aspirador"
  labels={['Reativo', 'Objetivos', 'Utilidade']}
>
  <div slot="panel-0">
    O reativo limpa as duas salas com quatro regras e sem memória. Escolhe-o
    quando a perceção atual chega para decidir e cada ação é barata. No
    aspirador, vagueia depois de limpar porque nenhuma regra reconhece o
    trabalho feito.
  </div>
  <div slot="panel-1">
    O baseado em objetivos guarda o que já viu e para quando as duas salas estão
    limpas. Escolhe-o quando há um estado final claro e vale a pena pesquisar a
    sequência até lá. É a arquitetura das páginas de pesquisa.
  </div>
  <div slot="panel-2">
    O baseado em utilidade compara custos: 3 ações contra 40, bateria gasta
    contra bateria poupada. Escolhe-o quando há compromissos entre qualidade e
    custo, como aceitar 95 por cento limpo por metade da energia.
  </div>
</Tabs>
