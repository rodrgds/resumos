...
import persona from '../../ipc/persona-requisito.typ?raw';
...
<Dot
  source="digraph UCD { rankdir=LR; Estudar -> Requisitos -> Idear -> Prototipar -> Avaliar -> Estudar; }"
  alt="Ciclo do design centrado no utilizador. Estudar leva a requisitos, depois idear, prototipar e avaliar, e a avaliação volta a estudar."
/>
...
<Typst
  source={persona}
  format="svg"
  alt="Cadeia persona cenário requisito. A Mariana organiza o grupo, o cenário conta propor cruzar e confirmar, e o requisito mede dois blocos com sala."
/>
...
<Tabs id="requisitos" labels={['Vago', 'Testável']}>
  <div slot="panel-0">

"O sistema deve ser rápido." "Combinar sessões deve ser fácil." "O grupo deve ser notificado." Nenhum diz quando está cumprido, por isso nenhum se consegue testar. São desejos, não requisitos.

  </div>
  <div slot="panel-1">

"Perante os horários de seis membros, o sistema apresenta pelo menos dois blocos comuns de 90 minutos com sala livre, em menos de 5 segundos." Condição, ação e medida: dá para testar e dá para falhar.
