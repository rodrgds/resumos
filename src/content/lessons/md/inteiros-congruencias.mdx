...
import relogio from './relogio.typ?raw';
...
<Tabs id="resto-linguagens" labels={['Python', 'C']}>
  <div slot="panel-0">

Em Python o operador `%` segue a convenção matemática, com o sinal do divisor:
...
Em C o resto segue o sinal do dividendo (truncação para zero):
...
$43 = 21 \cdot 2 + 1$; $21 = 10 \cdot 2 + 1$; $10 = 5 \cdot 2 + 0$; $5 = 2 \cdot 2 + 1$; $2 = 1 \cdot 2 + 0$; $1 = 0 \cdot 2 + 1$. Restos de trás para a frente: $101011_2$. Confirma: $32 + 8 + 2 + 1 = 43$. Para hexadecimal, agrupa de quatro em quatro bits: $10_2 = 2$, $1011_2 = 11 = B$, logo $43 = 2B_{16}$. Confirma: $2 \cdot 16 + 11 = 43$. No sentido inverso, de binário para decimal, soma as potências das posições com 1: $101011_2 = 32 + 8 + 2 + 1 = 43$, a mesma confirmação de trás para a frente.
...
<Typst
  source={relogio}
  format="svg"
  alt="Relógio módulo 12 com o 5 assinalado para as 17 horas e a soma 8 mais 6 a cair no 2."
/>
...
Para rever Euclides e inversos com mais exemplos resolvidos, os apontamentos de CSE 311 da Universidade de Washington cobrem o algoritmo estendido passo a passo: [Euclid's algorithm](https://courses.cs.washington.edu/courses/cse311/20sp/lectures/lecture14.html). Para treinar congruências com exercícios curtos, a wiki da Brilliant tem uma página dedicada: [Modular arithmetic](https://brilliant.org/wiki/modular-arithmetic/). E para experimentar restos antes de provar, há um applet interativo de aritmética modular: [Modular arithmetic](https://www.cut-the-knot.org/Curriculum/Algebra/Modulo.shtml).

<YouTube id="M7kEpw1tn50" title="Encryption and HUGE numbers" />
